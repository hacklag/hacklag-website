...
const TWEETS_URL = `https://api.syncano.io/v1.1/instances/${SYNCANO_HACKLAG_LOGIC_INSTANCE_NAME}/endpoints/data/fetchtweets/get/`;
const EVENTS_URL = `https://api.syncano.io/v1.1/instances/${SYNCANO_HACKLAG_LOGIC_INSTANCE_NAME}/endpoints/scripts/p/e7f851e8f6f2e279e94566410f4e13be09b1917b/fetchevents/?template=script_json`;
const SPONSORS_URL = `https://api.syncano.io/v1.1/instances/${SYNCANO_HACKLAG_LOGIC_INSTANCE_NAME}/endpoints/data/fetchpartners/get/`;
